...
| `.claude/SESSION-HANDOFF.md` | Live "where we are right now" pointer for resuming work (Phase 2.x gate, PR #28). Ephemeral; delete once Phase 2.x is accepted/merged. | Yes |
