...
| **2** | Paint → typed Renderer (net captures the full primitive stream) | ⏳ **in progress** — hoists (D48) + `Renderer` pilot: label/button extracted, zero diff (D49); remaining branches follow slice by slice |
