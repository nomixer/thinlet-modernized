...
/**
 * The {@code alignment} choice vocabulary of the 2005 DTD (DECISIONS.md D74).
...
public enum Alignment {
    ...
    public static final String KEY = "alignment";
    ...
    public static Alignment fromToken(String token) {
