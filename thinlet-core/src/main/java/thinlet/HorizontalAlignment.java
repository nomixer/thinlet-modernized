...
/**
 * The {@code halign} choice vocabulary of the 2005 DTD (DECISIONS.md D74).
...
public enum HorizontalAlignment {
    ...
    public static final String KEY = "halign";

    private final String token;

    HorizontalAlignment(String token) {
        this.token = token;
    }
    ...
    public static HorizontalAlignment fromToken(String token) {
