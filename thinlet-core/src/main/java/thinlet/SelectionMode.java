...
/**
 * The {@code selection} choice vocabulary of the 2005 DTD (DECISIONS.md D74).
...
public enum SelectionMode {
    ...
    public static final String KEY = "selection";

    private final String token;

    SelectionMode(String token) {
        this.token = token;
    }
    ...
    public static SelectionMode fromToken(String token) {
        for (SelectionMode value : values()) {
