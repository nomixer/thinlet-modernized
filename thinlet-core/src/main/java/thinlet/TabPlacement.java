...
/**
 * The {@code placement} choice vocabulary of the 2005 DTD (DECISIONS.md D74).
...
public enum TabPlacement {
    ...
    public static TabPlacement fromToken(String token) {
        for (TabPlacement value : values()) {
