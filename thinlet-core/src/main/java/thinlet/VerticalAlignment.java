...
/**
 * The {@code valign} choice vocabulary of the 2005 DTD (DECISIONS.md D74).
...
public enum VerticalAlignment {
    ...
    public static final String KEY = "valign";

    private final String token;

    VerticalAlignment(String token) {
        this.token = token;
    }
    ...
    public static VerticalAlignment fromToken(String token) {
        for (VerticalAlignment value : values()) {
