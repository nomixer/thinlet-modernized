...
public class DesktopProperties {
    ...
    public void loadProperties(
            Thinlet thinlet, Object colortable, Object geometrytable, Object fonttable, Object audiolist) {
        String[] keys = null;
        try { // 1.4
            ...
            for (int i = 0; i < keys.length; i++) {
                ...
                if (value instanceof Color) { // Color Properties
                    ...
                    if (icon == null) {
                        ...
                        icon = thinlet.createImage(new MemoryImageSource(12, 12, pix, 0, 12));
                    ...
                    addRow(
                            ...
                            keys[i],
                            icon,
                            "0x" + Integer.toHexString(rgb).substring(2));
