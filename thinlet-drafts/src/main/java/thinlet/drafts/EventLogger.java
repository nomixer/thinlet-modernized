...
public class EventLogger {
    ...
    public void buttonAction(String text) {
        log("button action " + text);
    }

    public void selectAction(String name, String text) {
        log(name + " select " + text);
    }

    public void doubleClick(String name, String text) {
        log(name + " double click " + text);
    }
    ...
    public void insert(String text, int start, int end) {
        log("insert " + text + " " + start + " " + end);
    }

    public void remove(String text, int start, int end) {
        log("remove " + text + " " + start + " " + end);
    }

    public void caret(String text, int start, int end) {
        log("caret " + text + " " + start + " " + end);
    }
    ...
    public void tabChanged(int selected) {
        log("tab changed " + selected);
    }

    public void menuAction(String text) {
        log("menuitem selected " + text);
    }
