...
public class SystemColors {
    ...
    private static final SystemColor[] systemcolors = {
        SystemColor.desktop,
    ...
    private static final String[] systemcolornames = {
        ...
        "active caption",
        "active caption text",
        "active caption border",
        "inactive caption",
        "inactive caption text",
        "inactive caption border",
        "window",
        "window border",
        "window text",
        "menu",
    ...
    public void loadSystemColors(Thinlet thinlet, Object list) {
        ...
        for (int i = 0; i < systemcolors.length; i++) {
            ...
            thinlet.setString(
                    item,
                    "text",
                    systemcolornames[i] + " (0x"
                            + Integer.toHexString(0xff000000 | systemcolors[i].getRGB())
                                    .substring(2) + ")");
