...
public class Widgets {
    ...
    public void loadText(Thinlet thinlet, Object textarea) throws Exception {
        ...
        BufferedReader reader = new BufferedReader(new FileReader(new File("src/thinlet/drafts/Widgets.java")));
        String line = null;
    ...
    public void showDialog(Thinlet thinlet) throws Exception {
        ...
        thinlet.setInteger(dialog, "width", 180);
        thinlet.setInteger(dialog, "height", 180);
